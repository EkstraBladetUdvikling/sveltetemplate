    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = text(" to learn\n    how the designsystem works");
    			t11 = space();
    			create_component(button.$$.fragment);
    			t12 = space();
    			create_component(accordion.$$.fragment);
    			add_location(h1, file, 9, 2, 424);
    			attr_dev(a0, "href", "https://svelte.dev/tutorial");
    			add_location(a0, file, 11, 14, 496);
    			add_location(p0, file, 10, 2, 478);
    			attr_dev(a1, "href", "https://ekstrabladetudvikling.github.io/eb-designsystem/");
    			add_location(a1, file, 14, 18, 620);
    			add_location(p1, file, 13, 2, 598);
    			attr_dev(main, "class", "");
    			add_location(main, file, 8, 0, 406);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
