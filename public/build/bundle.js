...
var app = (function () {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$2, 20, 2, 794);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t10 = text(" to learn how the designsystem works");
    			add_location(h1, file, 6, 2, 178);
    			attr_dev(a0, "href", "https://svelte.dev/tutorial");
    			add_location(a0, file, 8, 14, 250);
    			add_location(p0, file, 7, 2, 232);
    			attr_dev(a1, "href", "https://ekstrabladetudvikling.github.io/eb-designsystem/");
    			add_location(a1, file, 12, 18, 378);
    			add_location(p1, file, 11, 2, 356);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Button, Icon, name });
