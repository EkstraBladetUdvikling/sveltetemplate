    ...
    function create_fragment$F(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$F, 8, 0, 195);
    		},
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$3, 21, 2, 815);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 23, 2, 622);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$2, 19, 2, 530);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 8, 4, 331);
    			attr_dev(a0, "href", "https://svelte.dev/tutorial");
    			add_location(a0, file, 10, 16, 407);
    			add_location(p0, file, 9, 4, 387);
    			attr_dev(a1, "href", "https://ekstrabladetudvikling.github.io/eb-designsystem/");
    			add_location(a1, file, 13, 20, 537);
    			add_location(p1, file, 12, 4, 513);
    			attr_dev(main, "class", "grid-width--medium");
    			add_location(main, file, 7, 2, 293);
    			attr_dev(div, "class", "flex flex-justify--center");
    			add_location(div, file, 6, 0, 251);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
